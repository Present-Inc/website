...
module.exports = function (grunt) {
  ...
  // Default task.
  grunt.registerTask('default', ['test', 'dist', 'build-glyphicons-docs', 'build-customizer', 'update-shrinkwrap']);
  ...
  grunt.registerTask('build-glyphicons-docs', generateGlyphiconsData);
