$(function () {
    ...
    module('button')
      ...
      test('should return set state to loading', function () {
        var btn = $('<button class="btn" docs-loading-text="fat">mdo</button>')
      ...
      test('should toggle active when btn children are clicked', function () {
        var btn = $('<button class="btn" docs-toggle="button">mdo</button>'),
            inner = $('<i></i>')
        btn
          .append(inner)
      ...
      test('should toggle active when btn children are clicked within btn-group', function () {
        var btngroup = $('<div class="btn-group" docs-toggle="buttons"></div>'),
      ...
      test('should check for closest matching toggle', function () {
        var group = '<div class="btn-group" docs-toggle="buttons">' +
