$(function () {
    ...
    module('collapse')
      ...
      test('should add active class to target when collapse shown', function () {
        ...
        var target = $('<a docs-toggle="collapse" href="#test1"></a>')
      ...
      test('should remove active class from inactive accordion targets', function () {
        ...
        var target1 = $('<a docs-toggle="collapse" href="#body1" docs-parent="#accordion"></a>')
          .appendTo(accordion.find('.accordion-group').eq(0))

        var collapsible1 = $('<div id="body1" class="in"></div>')
          .appendTo(accordion.find('.accordion-group').eq(0))

        var target2 = $('<a class="collapsed" docs-toggle="collapse" href="#body2" docs-parent="#accordion"></a>')
          .appendTo(accordion.find('.accordion-group').eq(1))

        var collapsible2 = $('<div id="body2"></div>')
          .appendTo(accordion.find('.accordion-group').eq(1))

        var target3 = $('<a class="collapsed" docs-toggle="collapse" href="#body3" docs-parent="#accordion"></a>')
      ...
      test('should allow dots in docs-parent', function () {
        $.support.transition = false
        stop()
