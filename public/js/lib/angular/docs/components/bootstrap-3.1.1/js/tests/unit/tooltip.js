$(function () {
    ...
    module('tooltip')
      ...
      test('should add docs attribute for referencing original title', function () {
        var tooltip = $('<a href="#" rel="tooltip" title="Another tooltip"></a>').tooltip()
        equal(tooltip.attr('docs-original-title'), 'Another tooltip', 'original title preserved in docs attribute')
      })
      ...
      test('should destroy tooltip', function () {
        ...
        ok(tooltip.data('bs.tooltip'), 'tooltip has docs')
        ok($._data(tooltip[0], 'events').mouseover && $._data(tooltip[0], 'events').mouseout, 'tooltip has hover event')
        ok($._data(tooltip[0], 'events').click[0].namespace == 'foo', 'tooltip has extra click.foo event')
        tooltip.tooltip('show')
        tooltip.tooltip('destroy')
        ok(!tooltip.hasClass('in'), 'tooltip is hidden')
        ok(!$._data(tooltip[0], 'bs.tooltip'), 'tooltip does not have docs')
