	...
	grunt.initConfig({
		...
		jshint: {
			...
			tests: {
				...
				src: [ "test/docs/{test,testinit,testrunner}.js", "test/unit/**/*.js" ],
				options: {
		...
		testswarm: {
			tests: "ajax attributes callbacks core css docs deferred dimensions effects event manipulation offset queue selector serialize support traversing Sizzle".split(" ")
		},
