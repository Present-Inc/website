 ...
 *
 * @example url("docs/test.html")
 * @result "docs/test.html?10538358428943"
 *
 * @example url("docs/test.php?foo=bar")
 * @result "docs/test.php?foo=bar&10538358345554"
 */
function url( value ) {
...
this.testIframe = function( fileName, name, fn ) {
	...
	function loadFixture() {
		var src = url("./docs/" + fileName + ".html"),
...
this.testIframeWithCallback = function( title, fileName, func ) {
	...
	test( title, function() {
		...
		iframe = jQuery( "<div/>" ).append(
			jQuery( "<iframe/>" ).attr( "src", url( "./docs/" + fileName ) )
		).appendTo( "body" );
	});
};
