...
angular.module('pagesData', [])
  ...
  "api/ng/type/$compile.directive.Attributes": {
    ...
    "searchTerms": {
      ...
      "keywords": "$compile angular api attributes binding compile current docs-ng-bind directive dom element equivalent functions html js js-angular-release linking module needed ng ng-bind ng:bind normalization normalized object partials reflect shared src treated type values x-ng-bind"
    }
  },
  ...
  "api/ng/input/input[email]": {
    ...
    "searchTerms": {
      ...
      "keywords": "$error $scope $valid address adds angular api assignable attribute binding changes class clear constraint control ctrl docs-bind defined element email email-input-directive empty entered error evaluates example-email-input-directive examples executed expect expected expression expressions form function gettext html initialize inline input interaction invalid js js-angular-release key lang-html lang-js language longer match maxlength minlength model module ng ng-controller ng-model ng-show ngchange ngmaxlength ngminlength ngmodel ngpattern ngrequired outputfolder partials pattern patterns property protractor published regexp required runnable-example runnable-example-file runnable-example-frame scope sendkeys sets shorter src text tocontain toequal true type user valid validation var"
    }
  },
  ...
  "api/ng/input/input[checkbox]": {
    ...
    "searchTerms": {
      ...
      "keywords": "$scope angular api assignable binding change changes checkbox checkbox-input-directive class click control ctrl docs-bind element example-checkbox-input-directive examples executed expect expression form function gettext html input interaction js js-angular-release lang-html lang-js language model module ng ng-controller ng-false-value ng-model ng-true-value ngchange ngfalsevalue ngmodel ngtruevalue outputfolder partials property protractor published runnable-example runnable-example-file runnable-example-frame selected set src tocontain true type user value1 value2 var"
    }
  },
  ...
  "api/ng/directive/ngSubmit": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event $scope action additionally angular api attributes binding check class click css ctrl current docs-action default directive element empty enables enter eval events example-example33 examples expect expression expressions form function getattribute gettext guide hit html ignore input js js-angular-release lang-html lang-js language list module ng ng-controller ng-model ng-submit ngeventdirs ngsubmit object onsubmit outputfolder partials prevents protractor push reloading request runnable-example runnable-example-file runnable-example-frame sending server src strings submit text tobe tocontain type x-action"
    }
  },
  ...
  "api/ng/service/$filter": {
    ...
    "searchTerms": {
      "titleWords": "$filter",
      "keywords": "$filter api docs displayed expression filter filter_name filters formatting function general html js js-angular-release module ng partials retrieve service src syntax templates user"
    }
  },
  ...
  "error/$compile/nonassign": {
    ...
    "searchTerms": {
      ...
      "keywords": "$compile bind docs-binding docs-bound defined defines definition description_comprehensive-directive-api_directive-definition-object directive docs error example expression expressions factory function html invalid isolate js-angular-release mode mydirective myfn mymodule ng ngdoc non-assignable nonassign not-assignable occurs option order partials path properties property resolve return scope statement two-way values work write"
    }
  },
  ...
  "error/$resource/badargs": {
    ...
    "searchTerms": {
      "titleWords": "badargs",
      "keywords": "$resource action actions api arguments badargs custom docs docs documentation error expected html js-angular-release ngdoc ngresource occurs partials query refer reference success user-defined"
    }
  },
  "error/$resource/badcfg": {
    ...
    "searchTerms": {
      "titleWords": "badcfg",
      "keywords": "$resource actions actual api array arrays badcfg configuration configured docs default deserialized docs documentation error expect expected expects format html js-angular-release match matches ngdoc ngresource object objects occurs parameter partials query receives reference resolve resource response returned server service versa vice"
    }
  },
  ...
  "guide/dev_guide.templates.css-styling": {
    ...
    "searchTerms": {
      ...
      "keywords": "$rootscope angular application applies attached binding braces changed class classes css css-styling curly docs databinding defined dev_guide directive docs element example forms guide html input interaction interacts js-angular-release ng ng-bind ng-binding ng-dirty ng-invalid ng-pristine ng-scope ng-valid ngdoc overview partials pass provide scope scopes sets styling templates topics user validation widget working"
    }
  },
  ...
  "app.js": {
    "docType": "example-js",
    "id": "example-example78/server.js",
    "outputPath": "examples/example-example78/server.js",
    "path": "app.js"
  },
